...
// 音読み順に並べる（同じ読みの場合は元の配列順を保持する安定ソート）
const KANJI_LIST = grade3Kanji
  .map((k, i) => ({ ...k, _originalIndex: i }))
  .sort((a, b) => {
    if (a.sortReading < b.sortReading) return -1;
    if (a.sortReading > b.sortReading) return 1;
